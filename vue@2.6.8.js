...
(function (global, factory) {
  /**
   * 遵循 UMD 规范，UMD 规范是 commonjs 和 amd 的整合
   *
   * Vue 本质上是一个构造器，因此只能通过 new 关键字来使用，而不能直接通过函数调用
   */
  ...
  /**
   * Vue 内部默认的选项
   * 注册的组件选项、注册的过滤器、注册的指令
   *
   * Vue 提供了 keepAlie等默认的组件，
   * v-model、v-show 等内置指令
   */
  ...
  // 注册内置指令和组件
  // extend 方法实现了对象的合并，如果属性相同，则新的属性覆盖旧的属性
